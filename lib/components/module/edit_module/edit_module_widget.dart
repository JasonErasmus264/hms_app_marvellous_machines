...
class EditModuleWidget extends StatefulWidget {
  const EditModuleWidget({super.key});
...
class _EditModuleWidgetState extends State<EditModuleWidget> {
  ...
  void initState() {
    ...
    _model.txtCodeFocusNode!.addListener(() => safeSetState(() {}));
    _model.txtNameTextController ??= TextEditingController();
    _model.txtNameFocusNode ??= FocusNode();
    _model.txtNameFocusNode!.addListener(() => safeSetState(() {}));
                          ...
                          builder: (context, snapshot) {
                            ...
                            return FlutterFlowDropDown<int>(
                              ...
                              onChanged: (val) async {
                                ...
                                _model.getModule =
                                    await ModuleGroup.getModuleCall.call(
                                  moduleID: _model.dropDownValue?.toString(),
                                  token: currentAuthenticationToken,
                                );

                                if ((_model.getModule?.succeeded ?? true)) {
                                  safeSetState(() {
                                  ...
                                  await showDialog(
                                    ...
                                    builder: (alertDialogContext) {
                                      return AlertDialog(
                                        ...
                                        content: Text(ModuleGroup.getModuleCall
                                            .errorMessage(
                                          (_model.getModule?.jsonBody ?? ''),
                                        )!),
                                        actions: [
                                    ...
                                    children: [
                                      Padding(
                                        ...
                                        child: SizedBox(
                                          ...
                                          child: TextFormField(
                                            controller:
                                                _model.txtCodeTextController,
                                            focusNode: _model.txtCodeFocusNode,
                                            autofocus: true,
                                            textCapitalization:
