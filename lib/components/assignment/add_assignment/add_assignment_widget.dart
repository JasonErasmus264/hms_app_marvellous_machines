...
class _AddAssignmentWidgetState extends State<AddAssignmentWidget> {
  ...
  void initState() {
    ...
    _model.txtTotalMarksTextController ??= TextEditingController();
    _model.txtTotalMarksFocusNode ??= FocusNode();
    _model.txtTotalMarksFocusNode!.addListener(() => safeSetState(() {}));
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: SizedBox(
                                    ...
                                    child: TextFormField(
                                      controller:
                                          _model.txtTotalMarksTextController,
                                      focusNode: _model.txtTotalMarksFocusNode,
                                      autofocus: false,
                                      textCapitalization:
                                          TextCapitalization.words,
                                      textInputAction: TextInputAction.next,
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                                ...
                                await showDialog(
                                  ...
                                  builder: (alertDialogContext) {
                                    return AlertDialog(
                                      ...
                                      content: const Text('Enter an open date'),
                                      actions: [
                                        TextButton(
                                          onPressed: () =>
                              ...
                              if (_model.datePicked2 == null) {
                                await showDialog(
                                  ...
                                  builder: (alertDialogContext) {
                                    return AlertDialog(
                                      title: const Text('Error'),
                                      content: const Text('Enter a due date'),
                                      actions: [
                                        TextButton(
                                          onPressed: () =>
                                              Navigator.pop(alertDialogContext),
                              ...
                              _model.apiResult =
                                  await AssignmentGroup.addAssignmentCall.call(
                                moduleID: widget.moduleID,
                                assignName: _model.txtTitleTextController.text,
                                assignDesc: functions.formatTextForJson(
                                    _model.txtDescriptionTextController.text),
                                assignOpenDate: _model.datePicked1?.toString(),
                                assignDueDate: _model.datePicked2?.toString(),
                                assignTotalMarks:
                                    _model.txtTotalMarksTextController.text,
